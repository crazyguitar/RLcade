use super::common::NesPixel;

// 2C02 NTSC palette (64 entries, 0x00RRGGBB)
// ref: http://www.romdetectives.com/Wiki/index.php?title=NES_Palette
pub const PALETTE: [NesPixel; 64] = [
