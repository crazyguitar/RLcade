...
def add_training_args(parser):
    ...
    parser.add_argument("--mlflow", type=str, nargs="?", const="", default=None, help="Enable MLflow logging")
    parser.add_argument("--mlflow-experiment", type=str, default="rlcade", help="MLflow experiment name")
    parser.add_argument("--mlflow-run-name", type=str, default=None, help="MLflow run name (default: auto)")
    parser.add_argument("--wandb", type=str, nargs="?", const="", default=None, help="Enable W&B logging")
    parser.add_argument("--wandb-entity", type=str, default=None, help="Wandb entity (user or team)")
    parser.add_argument("--wandb-project", type=str, default="rlcade", help="Wandb project name")
    parser.add_argument("--wandb-run-name", type=str, default=None, help="Wandb run name (default: auto)")
    # Curriculum learning
